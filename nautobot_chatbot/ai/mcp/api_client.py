...
class NautobotAPIClient:
    ...
    def get_devices(self, limit: int = 10, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
    ...
    def get_sites(self, limit: int = 10, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def get_circuits(self, limit: int = 10, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def get_ip_addresses(self, limit: int = 10, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def get_prefixes(self, limit: int = 10, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def search_objects(self, query: str, object_type: Optional[str] = None, limit: int = 10) -> Dict[str, Any]:
        """
