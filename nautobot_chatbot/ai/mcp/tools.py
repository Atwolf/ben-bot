...
class NavigationTool(MCPTool):
    ...
    NAVIGATION_MAP = {
        # Organization
        "sites": {"url": "/dcim/sites/", "description": "View all sites and locations"},
        "racks": {"url": "/dcim/racks/", "description": "View all racks"},
        "devices": {"url": "/dcim/devices/", "description": "View device inventory"},
        "device_types": {"url": "/dcim/device-types/", "description": "View device types"},
        "device_roles": {"url": "/dcim/device-roles/", "description": "View device roles"},
        "manufacturers": {"url": "/dcim/manufacturers/", "description": "View manufacturers"},
        # IPAM
        "ip_addresses": {"url": "/ipam/ip-addresses/", "description": "View IP addresses"},
        "prefixes": {"url": "/ipam/prefixes/", "description": "View IP prefixes"},
        "vlans": {"url": "/ipam/vlans/", "description": "View VLANs"},
        "vrfs": {"url": "/ipam/vrfs/", "description": "View VRFs (Virtual Routing and Forwarding)"},
        # Circuits
        "circuits": {"url": "/circuits/circuits/", "description": "View circuits"},
        "circuit_types": {"url": "/circuits/circuit-types/", "description": "View circuit types"},
        "providers": {"url": "/circuits/providers/", "description": "View circuit providers"},
        # Cables and Connections
        "cables": {"url": "/dcim/cables/", "description": "View cable connections"},
        "interfaces": {"url": "/dcim/interfaces/", "description": "View device interfaces"},
        # Admin and Configuration
        "users": {"url": "/admin/users/", "description": "Manage users (admin only)"},
        "groups": {"url": "/admin/groups/", "description": "Manage user groups (admin only)"},
        "api_tokens": {"url": "/users/api-tokens/", "description": "Manage API tokens"},
        # Extras
        "tags": {"url": "/extras/tags/", "description": "View and manage tags"},
        "custom_fields": {"url": "/extras/custom-fields/", "description": "Manage custom fields"},
        "webhooks": {"url": "/extras/webhooks/", "description": "Configure webhooks"},
    }
        ...
        if page_type in self.NAVIGATION_MAP:
            ...
            for key, value in self.NAVIGATION_MAP.items():
                if page_type in key or page_type in value["description"].lower():
                    matches.append(
                        {"key": key, "url": value["url"], "description": value["description"]}
                    )
...
class CreateObjectTool(MCPTool):
    ...
    CREATE_MAP = {
        "site": {"url": "/dcim/sites/add/", "description": "Create a new site"},
        "device": {"url": "/dcim/devices/add/", "description": "Create a new device"},
        "rack": {"url": "/dcim/racks/add/", "description": "Create a new rack"},
        "circuit": {"url": "/circuits/circuits/add/", "description": "Create a new circuit"},
        "ip_address": {"url": "/ipam/ip-addresses/add/", "description": "Create a new IP address"},
        "prefix": {"url": "/ipam/prefixes/add/", "description": "Create a new IP prefix"},
        "vlan": {"url": "/ipam/vlans/add/", "description": "Create a new VLAN"},
        "cable": {"url": "/dcim/cables/add/", "description": "Create a new cable connection"},
    }

    def __init__(self):
        super().__init__(
            name="create_object", description="Generate links to create new objects in Nautobot"
        )
...
class MCPToolRegistry:
    ...
    def _register_default_tools(self):
        ...
        default_tools = [NavigationTool(), SearchTool(), CreateObjectTool()]
