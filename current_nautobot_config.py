...
DATABASES = {
    "default": {
        "NAME": os.getenv("DB_NAME", "nautobot"),  # Database name
        "USER": os.getenv("DB_USER", "nautobot"),  # Database username
        "PASSWORD": os.getenv("DB_PASSWORD", "E1x3oasg"),  # Datbase password
